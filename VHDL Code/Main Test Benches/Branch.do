...
run
run
force -freeze sim:/main/IN_PORT 32'h30 0
run
force -freeze sim:/main/IN_PORT 32'h50 0
run
force -freeze sim:/main/IN_PORT 32'h100 0
run
force -freeze sim:/main/IN_PORT 32'h300 0
run
force -freeze sim:/main/IN_PORT 32'hFFFFFFFF 0
run
run
force -freeze sim:/main/INT 1 0
run
force -freeze sim:/main/INT 0 0
force -freeze sim:/main/IN_PORT 32'h200 0
run
run
run
run
